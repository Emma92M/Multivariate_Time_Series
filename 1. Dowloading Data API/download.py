#1. Dowloading Data API/download.py
...
from sentinelsat import SentinelAPI #Copenicus Python enabled library 

#This scrip connect to API and dowload data on bulk. The script has been taken from the following github repo:

#https://github.com/pherrusa7/Sentinel5P/blob/master/download.py
...
def set_parser():
    ...
    parser.add_argument("-c", "--city", type=str, required=True, 
                        help="City to download the data from [Berlin]")
...
def prepare_download(city, folder, level='L2', date_range=['20200501', '20210831']):
    ...
    polys = { # 566
             'Berlin': "POLYGON((12.558777671087848 52.03654820015532,14.114302561752853 52.03654820015532,14.114302561752853 53.025487507188046,12.558777671087848 53.025487507188046,12.558777671087848 52.03654820015532))" } # 
